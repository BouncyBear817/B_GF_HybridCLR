...
namespace GameMain.Builtin
{
    public class NetworkChannelHelper : INetworkChannelHelper, IReference
    {
        ...
        public void Initialize(INetworkChannel networkChannel)
        {
            ...
            MainEntry.Event.Subscribe(UnityGameFramework.Runtime.NetworkConnectedEventArgs.EventId, OnNetworkConnected);
            MainEntry.Event.Subscribe(UnityGameFramework.Runtime.NetworkClosedEventArgs.EventId, OnNetworkClosed);
            MainEntry.Event.Subscribe(UnityGameFramework.Runtime.NetworkCustomErrorEventArgs.EventId, OnNetworkCustomError);
            MainEntry.Event.Subscribe(UnityGameFramework.Runtime.NetworkErrorEventArgs.EventId, OnNetworkError);
            MainEntry.Event.Subscribe(UnityGameFramework.Runtime.NetworkMissHeartBeatEventArgs.EventId, OnNetworkMissHeartBeat);
        }
        ...
        {
            MainEntry.Event.Unsubscribe(UnityGameFramework.Runtime.NetworkConnectedEventArgs.EventId, OnNetworkConnected);
            MainEntry.Event.Unsubscribe(UnityGameFramework.Runtime.NetworkClosedEventArgs.EventId, OnNetworkClosed);
            MainEntry.Event.Unsubscribe(UnityGameFramework.Runtime.NetworkCustomErrorEventArgs.EventId, OnNetworkCustomError);
            MainEntry.Event.Unsubscribe(UnityGameFramework.Runtime.NetworkErrorEventArgs.EventId, OnNetworkError);
            MainEntry.Event.Unsubscribe(UnityGameFramework.Runtime.NetworkMissHeartBeatEventArgs.EventId, OnNetworkMissHeartBeat);
        ...
        {
            var eventArgs = e as UnityGameFramework.Runtime.NetworkConnectedEventArgs;
        ...
        {
            var eventArgs = e as UnityGameFramework.Runtime.NetworkClosedEventArgs;
            if (eventArgs == null || eventArgs.NetworkChannel != mNetworkChannel)
            {
                return;
            }
        ...
        {
            var eventArgs = e as UnityGameFramework.Runtime.NetworkCustomErrorEventArgs;
            if (eventArgs == null || eventArgs.NetworkChannel != mNetworkChannel)
            {
                return;
            }
        ...
        {
            var eventArgs = e as UnityGameFramework.Runtime.NetworkErrorEventArgs;
            if (eventArgs == null || eventArgs.NetworkChannel != mNetworkChannel)
            {
                return;
            }
        ...
        {
            var eventArgs = e as UnityGameFramework.Runtime.NetworkMissHeartBeatEventArgs;
            if (eventArgs == null || eventArgs.NetworkChannel != mNetworkChannel)
            {
                return;
            }

...
namespace GameMain.Editor
{
    ...
    public class UIAutoBindToolInspector : UnityEditor.Editor
    {
        ...
        private UIAutoBindGlobalSettings mUIAutoBindGlobalSettings;
        ...
        private void DrawSetting()
        {
            ...
            {
                mComponentCodePath.stringValue = mUIAutoBindGlobalSettings.ComponentCodePath;
            }
            ...
            if (GUILayout.Button("Default", GUILayout.Width(100)))
            {
                mMountCodePath.stringValue = mUIAutoBindGlobalSettings.MountCodePath;
            }
        ...
        private void GenerateAutoBindCode()
        {
            ...
            var codePath = string.IsNullOrEmpty(mTarget.ComponentCodePath)
                ? mUIAutoBindGlobalSettings.ComponentCodePath
            ...
            using (var sw = new StreamWriter(filePath))
            {
                ...
                sw.WriteLine("\t\t\tvar uiAutoBindTool = go.GetComponent<Builtin.UIAutoBindTool>();\n");
        ...
        private void GenerateMountCode(GameObject go, string className)
        {
            var codePath = string.IsNullOrEmpty(mTarget.MountCodePath)
                ? mUIAutoBindGlobalSettings.MountCodePath
        ...
        private void AutoBindComponent()
        {
            ...
            foreach (var transform in transforms)
            {
                ...
                if (UIAutoBindGlobalSettings.IsValidBind(transform, mTempFiledNameList, mTempTypeNameList))
                {

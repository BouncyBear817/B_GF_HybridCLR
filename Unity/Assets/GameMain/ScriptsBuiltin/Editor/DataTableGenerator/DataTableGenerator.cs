...
namespace GameMain.Editor
{
    ...
    public static class DataTableGenerator
    {
        ...
        {
            return new DataTableProcessor(GetDataTablePath(dataTableName), Encoding.GetEncoding("UTF-8"), 1, 2, null, 3, 4, 1);
        }
        ...
        private static string GetDataTablePath(string dataTableName) =>
            GameFramework.Utility.Path.GetRegularPath(Path.Combine(DataTableConstant.DataTablePath, dataTableName + DataTableConstant.TxtSuffix));
        ...
        private static void DataTableCodeGenerator(DataTableProcessor dataTableProcessor, StringBuilder codeContent, object userData)
        {
            ...
            codeContent.Replace("__DATA_TABLE_NAME_SPACE__", "GameMain.Hotfix");
